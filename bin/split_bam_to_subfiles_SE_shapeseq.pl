...
## This is a modified script from split_bam_to_subfiles_SE.pl - SHAPE read names look different and the randomer needs to be searched for in a different place.
use warnings;
use strict;

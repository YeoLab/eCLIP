...
# baseCommand: [peakscompresspy.py]
baseCommand: [fix_ld_library_path, peakscompresspy.py]
...
arguments: [ --outputbed, $(inputs.input_bed.nameroot)Co.bed ]
...
outputs:
  ...
  output_bed:
    ...
    format: http://edamontology.org/format_3003
    outputBinding:
      glob: $(inputs.input_bed.nameroot)Co.bed

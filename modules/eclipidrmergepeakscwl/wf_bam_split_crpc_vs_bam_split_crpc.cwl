...
outputs:
  ...
  bam_rep1_splits_reproducing_peaks_count:
    type: int
    outputSource: bam_rep1_splits_clipperreproducingpeakscount/reproducing_peaks_count

  bam_rep2_splits_reproducing_peaks_count:
    type: int
    outputSource: bam_rep2_splits_clipperreproducingpeakscount/reproducing_peaks_count
...
steps:
  ...
  bam_rep1_splits_clipperreproducingpeakscount:
    ...
    in:
      ...
      bam_rep2: bam_rep1_split/split2
...
#      mergedPeakCustomBedFilename: mergedPeakCustomBedFilename
  ...
  bam_rep2_splits_clipperreproducingpeakscount:
    run: wf_bams_clipperreproducingpeakscount.cwl
    in:
      bam_rep1: bam_rep2_split/split1

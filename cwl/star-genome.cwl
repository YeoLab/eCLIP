...
inputs:
  ...
  seedSearchStartLmax:
    ...
    doc: '50
      ...
      '
  runMode:
    # default: alignReads  # TODO: eCLIP 0.1.5 Defaults
    type: string
    default: alignReads
    inputBinding:
      position: 1
  ...
  outFilterMultimapNmax:
    default: 1 # Default for eCLIP genome mapping
    type: int
    inputBinding:
      position: 1
    ...
    doc: '10
      ...
      '
  outFileNamePrefix:
    # Takes read1 name (readFilesIn[0]) as outprefix base
    default: ""  # TODO: eCLIP 0.1.5 Defaults
    type: string?
    inputBinding:
      position: 1
      ...
      valueFrom: |
        ${
          if (inputs.outFileNamePrefix == "") {
            return inputs.readFilesIn[0].nameroot + ".STAR";
          }
          else {
            return inputs.outFileNamePrefix;
          }
        }
    doc: |
  ...
  readFilesIn:
    # TODO: change to File for single end
    type: File[]?
    inputBinding:
      position: 1
      # itemSeparator: ' '
  ...
  alignEndsType:
    default: EndToEnd  # TODO: eCLIP 0.1.5 Defaults
    type: string?
    inputBinding:
      position: 1
  ...
  runThreadN:
    default: 8 # TODO: change if necessary
    type: int?
    inputBinding:
      position: 1
      prefix: --runThreadN
  ...
  outFilterMultimapScoreRange:
    default: 1  # TODO: eCLIP 0.1.5 Defaults
    type: int?
    inputBinding:
      position: 1
  ...
  outFilterType:
    default: BySJout  # TODO: eCLIP 0.1.5 Defaults
    type: string?
    inputBinding:
      position: 1
  ...
  outSAMtype:
    type:
      type: array
      items: string
    default: [BAM, Unsorted]  # TODO: eCLIP 0.1.5 Defaults
    inputBinding:
      position: 1
      prefix: --outSAMtype
    doc: |
  ...
  outFilterScoreMin:
    default: 10  # TODO: eCLIP 0.1.5 Defaults
    type: int?
    inputBinding:
      position: 1
    ...
    doc: '0
      ...
      '
  outReadsUnmapped:
    default: Fastx  # TODO: eCLIP 0.1.5 Defaults
    type: string?
    inputBinding:
      position: 1
